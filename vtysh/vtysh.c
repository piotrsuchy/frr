...
static void show_access_list_send(afi_t afi, const char *access_list,
				  bool json)
{
	unsigned int i;
	bool first = true;
...
DEFPY (show_ip_access_list_name,
       ...
       "show ip access-list ACCESSLIST4_NAME [json$uj]",
       SHOW_STR
       IP_STR
       "List IP access lists\n"
       "IP access-list name\n"
...
DEFPY (show_ipv6_access_list_name,
       ...
       "show ipv6 access-list ACCESSLIST6_NAME [json$uj]",
       SHOW_STR
       IPV6_STR
       "List IPv6 access lists\n"
